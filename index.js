...
const { MAKE_WEBHOOK } = process.env;
                    ...
                    messages: [
                        {
                            role: "system",
                            content:
                                "Extract customer details: name, phone number, pickup or delivery time and any special notes from the transcript.",
                        },
